...
var s = {
  ...
  return this.each(function(){
	...
	// we don't want to append, we wanna override
	var list = $('<ul>');
	$(this).html(list)//.appendTo(this);
	...
	$.getJSON(url, function(r){
      if (r.stat != "ok"){
        ...
        list.append('<input type="hidden" id="fPage" value="'+r.photos.page+'" />');
        list.append('<input type="hidden" id="fPages" value="'+r.photos.pages+'" />');
        list.append('<input type="hidden" id="fPerPage" value="'+r.photos.perpage+'" />');
        list.append('<input type="hidden" id="fTotal" value="'+r.photos.total+'" />');
